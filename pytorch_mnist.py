...
parser.add_argument(
    "--hosts", help="hosts to run on in notation: hostname:slots[,host2:slots[,...]]"
)
parser.add_argument(
    "--communication", help="collaborative communication to use: gloo, mpi"
)
...
def main(args):
    ...
    if args.use_mixed_precision and version.parse(torch.__version__) < version.parse(
        "1.6.0"
    ):
        raise ValueError(
